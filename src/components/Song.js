          ...
          <Col className=' col-sm-8 col-md-5 p-4 order-first' >
            <Card className='bg-dark bg-opacity-75 rounded'>
              ...
              <Card.Body className='text-white'>
                <Card.Title className=''><h2>{songDetails.title}</h2></Card.Title>
                <Card.Text className='text-white-50'>{songDetails.artists && songDetails.artists[0].fullName}</Card.Text>
              </Card.Body>
              <ListGroup className='p-0 mx'>
                <div className=' buttons row row-cols-6 m-3 bg-dark bg-opacity-25'>
                  <img  src={ShuffleImg} />
                  <img src={PreviousImg} />
                  <React.StrictMode>
